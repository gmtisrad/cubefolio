...
import { headerStyle, skillsWrapperStyles } from "../src/client/styles";

export const ReactIcon: React.FC = () => {
  return (
    <svg id="Layer_2" version="1.1" viewBox="0 0 600 600">
...
export const FrontEnd: React.FC = () => {
  ...
  return (
    <div className={cx(introWrapperStyle(textColor), skillsWrapperStyles)}>
      <h1 className={headerStyle(textColor)}>Front End</h1>
    </div>
  );
};
